...
import 'package:flixage/bloc/album/album_bloc.dart';
...
class AlbumPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Album album = (ModalRoute.of(context).settings.arguments as Map)['album'];
                  ...
                  children: [
                    ...
                    ListView.separated(
                        ...
                        itemBuilder: (_, index) => TrackItem(
                              ...
                              subheader: Text(tracks[index].streamCount.toString()),
                            ),
